...
export class MessageModal extends Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (
            ...
            prevProps.messageInfo !== messageInfo
        )
        ...
        switch (name) {
            case 'receiver':
                valid =
                    ...
                    Validator.isEmpty(sanitizedValue);
                break;
            case 'message':
                valid = true;
                break;
    ...
    sendMessage() {
        ...
        if (valid)
            sendMessage(
                credential
                    ? credential.idCredentials
                    : {
                          description:
                              credentialForm.description.sanitizedValue,
                          username: credentialForm.username.sanitizedValue,
                          title: credentialForm.title.sanitizedValue,
                          password: credentialForm.password.sanitizedValue,
                          url: credentialForm.url.sanitizedValue,
    ...
    render() {
        ...
        return (
            <Dialog
                ...
                <DialogTitle>{!isFetching && <ModalHeader />}</DialogTitle>
                <DialogContent>
                    {isFetching && (
                        <Fade in>
                            <CircularProgress />
                            ...
                            {isCreating && (
                                <div
                                    ...
                                    {!isExternal ? (
                                        ...
                                        <FormControl
                                            error={!fields.receiver.valid}
                                            disabled={!isEditing}
                                            className={classNames(
                                                classes.emailInput,
                                            )}>
                                            <InputLabel htmlFor="receiver">
                                                <Translate id="receiver" />
                                            </InputLabel>
                                            <Input
                                                id="receiver"
                                                value={fields.receiver.value}
                                            ...
                                            />
                                            <Grow
                                                in={!fields.receiver.valid}
                                                unmountOnExit>
                                                <FormHelperText>
                                                    <Translate id="receiverNotMandatory" />
                                                </FormHelperText>
                                            </Grow>
                                        </FormControl>
                                    )}
                    ...
                    <Fade
                        ...
                        <div
                            style={{
                                display: sendResult ? 'flex' : 'none',
                                flexDirection: 'column',
                                position: 'absolute',
                            }}>
                            {sendResult && sendResult.sent && (
                                <Typography>
                                    <Translate id="emailSent" />
                                </Typography>
                            )}
                    ...
                    <Slide in={!isFetching && choosingCredentialLocation}>
                        <div
                            style={{
                                display: choosingCredentialLocation
                                    ? 'flex'
                                    : 'none',
                                flexDirection: 'column',
                            }}>
                            ...
                            {!readonly &&
                                (!choosingCredentialLocation ? (
                                    <Button
                                        ...
                                        onClick={moveToCredentialLocationStep}
                                        color="secondary">
...
const mapStateToProps = state => ({
    ...
    isEditing:
        state.messages.modal.isEditing || state.messages.modal.isCreating,
...
export default connect(
    mapStateToProps,
    mapDispatchToProps,
)(withStyles(styles)(withSnackbar(withLocalize(MessageModal))));
